        ...
        <div class="min-h-screen bg-gray-50">
            ...
            <div class="bg-gradient-to-br from-red-600 via-red-700 to-red-800 text-white py-16">
                <div class="max-w-7xl mx-auto px-4 text-center">
                    ...
                    <p v-if="category.description" class="text-xl text-red-100 max-w-2xl mx-auto">
                        {{ category.description }}
                    </p>
                    <p v-else class="text-lg text-red-100 max-w-2xl mx-auto">
                        {{ category.name }} kategorisindeki tüm yazılar
                    </p>
                    
                    <div class="mt-6 flex items-center justify-center gap-4 text-red-200">
            ...
            <div class="max-w-7xl mx-auto px-4 py-12">
                ...
                <div v-if="posts.data.length === 0" class="text-center py-16">
                    ...
                    <p class="text-gray-500 mb-4">Bu kategoride henüz yazı bulunmuyor.</p>
