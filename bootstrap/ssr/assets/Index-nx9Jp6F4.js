    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AppLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ne-izlesem" data-v-6dd721f0${_scopeId}><header class="ne-izlesem__header" data-v-6dd721f0${_scopeId}><div class="ne-izlesem__header-inner" data-v-6dd721f0${_scopeId}><div class="ne-izlesem__kicker" data-v-6dd721f0${_scopeId}>SİNEMA REHBERİ</div><h1 class="ne-izlesem__title" data-v-6dd721f0${_scopeId}>Ne İzlesem?</h1><p class="ne-izlesem__subtitle" data-v-6dd721f0${_scopeId}> Ruh haline, zamanına ve tercihlerine göre sana özel film &amp; dizi önerileri. <span class="ne-izlesem__badge" data-v-6dd721f0${_scopeId}>Vertex AI</span></p></div></header><div class="ne-izlesem__layout" data-v-6dd721f0${_scopeId}>`);
            _push2(ssrRenderComponent(ConversationHistory, {
              conversations: __props.conversations,
              "active-id": conversationId.value
            }, null, _parent2, _scopeId));
            _push2(`<div class="ne-izlesem__body" data-v-6dd721f0${_scopeId}><div class="ne-izlesem__chat-wrapper" data-v-6dd721f0${_scopeId}>`);
            if (isReturningUser.value && messages.value.length > 0) {
              _push2(`<div class="ne-izlesem__resume-banner" data-v-6dd721f0${_scopeId}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-6dd721f0${_scopeId}><path d="M12 8v4l3 3" data-v-6dd721f0${_scopeId}></path><circle cx="12" cy="12" r="9" data-v-6dd721f0${_scopeId}></circle></svg><span data-v-6dd721f0${_scopeId}>Son sohbetine devam ediyorsun</span></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="ne-izlesem__messages" data-v-6dd721f0${_scopeId}>`);
            if (messages.value.length === 0) {
              _push2(`<div class="ne-izlesem__empty" data-v-6dd721f0${_scopeId}><div class="ne-izlesem__empty-icon" data-v-6dd721f0${_scopeId}><svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-6dd721f0${_scopeId}><rect x="4" y="8" width="40" height="32" rx="2" stroke="currentColor" stroke-width="2" data-v-6dd721f0${_scopeId}></rect><rect x="8" y="12" width="8" height="6" rx="1" fill="currentColor" opacity="0.3" data-v-6dd721f0${_scopeId}></rect><rect x="20" y="12" width="8" height="6" rx="1" fill="currentColor" opacity="0.3" data-v-6dd721f0${_scopeId}></rect><rect x="32" y="12" width="8" height="6" rx="1" fill="currentColor" opacity="0.3" data-v-6dd721f0${_scopeId}></rect><rect x="8" y="22" width="8" height="6" rx="1" fill="currentColor" opacity="0.3" data-v-6dd721f0${_scopeId}></rect><rect x="20" y="22" width="8" height="6" rx="1" fill="currentColor" opacity="0.3" data-v-6dd721f0${_scopeId}></rect><rect x="32" y="22" width="8" height="6" rx="1" fill="currentColor" opacity="0.3" data-v-6dd721f0${_scopeId}></rect><rect x="8" y="32" width="8" height="4" rx="1" fill="currentColor" opacity="0.3" data-v-6dd721f0${_scopeId}></rect><rect x="20" y="32" width="8" height="4" rx="1" fill="currentColor" opacity="0.3" data-v-6dd721f0${_scopeId}></rect><rect x="32" y="32" width="8" height="4" rx="1" fill="currentColor" opacity="0.3" data-v-6dd721f0${_scopeId}></rect></svg></div><h2 class="ne-izlesem__empty-title" data-v-6dd721f0${_scopeId}>Merhaba, sinema sever!</h2><p class="ne-izlesem__empty-desc" data-v-6dd721f0${_scopeId}> Ruh halini ya da ne tarz bir şey izlemek istediğini yaz, sana en uygun filmleri ve dizileri önereyim. </p><div class="ne-izlesem__prompt-groups" data-v-6dd721f0${_scopeId}><!--[-->`);
              ssrRenderList(promptGroups, (group) => {
                _push2(`<div class="ne-izlesem__prompt-group" data-v-6dd721f0${_scopeId}><div class="ne-izlesem__prompt-group-label" data-v-6dd721f0${_scopeId}>${ssrInterpolate(group.label)}</div><div class="ne-izlesem__prompts" data-v-6dd721f0${_scopeId}><!--[-->`);
                ssrRenderList(group.prompts, (prompt) => {
                  _push2(`<button class="ne-izlesem__prompt-btn" data-v-6dd721f0${_scopeId}><span class="ne-izlesem__prompt-icon" data-v-6dd721f0${_scopeId}>${ssrInterpolate(prompt.icon)}</span> ${ssrInterpolate(prompt.text)}</button>`);
                });
                _push2(`<!--]--></div></div>`);
              });
              _push2(`<!--]--></div></div>`);
            ...
            ssrRenderList(messages.value, (msg) => {
              _push2(`<div class="${ssrRenderClass([msg.role === "user" ? "ne-izlesem__msg--user" : "ne-izlesem__msg--ai", "ne-izlesem__msg"])}" data-v-6dd721f0${_scopeId}>`);
              if (msg.role !== "user") {
                _push2(`<div class="ne-izlesem__msg-avatar" data-v-6dd721f0${_scopeId}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-v-6dd721f0${_scopeId}><path d="M15.91 11.72a.5.5 0 010 .56l-1.2 2.08a.5.5 0 01-.43.25H12.6a.5.5 0 01-.44-.25l-1.2-2.08a.5.5 0 010-.56l1.2-2.08a.5.5 0 01.44-.25h1.68a.5.5 0 01.43.25l1.2 2.08z" data-v-6dd721f0${_scopeId}></path><circle cx="12" cy="12" r="10" data-v-6dd721f0${_scopeId}></circle></svg></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="ne-izlesem__msg-bubble" data-v-6dd721f0${_scopeId}>`);
              if (msg.role === "user") {
                _push2(`<div class="ne-izlesem__msg-text" data-v-6dd721f0${_scopeId}>${ssrInterpolate(msg.content)}</div>`);
              } else {
                _push2(`<!--[--><div class="ne-izlesem__msg-text" data-v-6dd721f0${_scopeId}>${renderMarkdown(msg.content) ?? ""}</div>`);
                if (assistantMeta(msg).site_posts?.length) {
                  _push2(`<div class="ne-izlesem__link-block" data-v-6dd721f0${_scopeId}><div class="ne-izlesem__link-title" data-v-6dd721f0${_scopeId}>Ben İzledim içinde</div><div class="ne-izlesem__suggestion-grid" data-v-6dd721f0${_scopeId}><!--[-->`);
                  ssrRenderList(assistantMeta(msg).site_posts, (post) => {
                    _push2(ssrRenderComponent(unref(Link), {
                      ...
                      default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                        if (_push3) {
                          _push3(`<span class="ne-izlesem__suggestion-kicker" data-v-6dd721f0${_scopeId2}>Yazı linki</span><span class="ne-izlesem__suggestion-name" data-v-6dd721f0${_scopeId2}>${ssrInterpolate(post.title)}</span>`);
                        } else {
                          return [
                ...
                if (assistantMeta(msg).external_suggestions?.length) {
                  _push2(`<div class="ne-izlesem__link-block" data-v-6dd721f0${_scopeId}><div class="ne-izlesem__link-title" data-v-6dd721f0${_scopeId}>Site dışında da bak</div><div class="ne-izlesem__suggestion-grid" data-v-6dd721f0${_scopeId}><!--[-->`);
                  ssrRenderList(assistantMeta(msg).external_suggestions, (item) => {
                    ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(item.url ? "a" : "div"), {
                      ...
                      default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                        if (_push3) {
                          _push3(`<span class="ne-izlesem__suggestion-kicker" data-v-6dd721f0${_scopeId2}>${ssrInterpolate(item.type === "series" ? "Dizi" : "Film")}${ssrInterpolate(item.year ? ` / ${item.year}` : "")}</span><span class="ne-izlesem__suggestion-name" data-v-6dd721f0${_scopeId2}>${ssrInterpolate(item.title)}</span>`);
                          if (item.reason) {
                            _push3(`<span class="ne-izlesem__suggestion-desc" data-v-6dd721f0${_scopeId2}>${ssrInterpolate(item.reason)}</span>`);
                          } else {
                            _push3(`<!---->`);
                          }
                        } else {
                ...
                if (assistantMeta(msg).follow_up_options?.length) {
                  _push2(`<div class="ne-izlesem__followups" data-v-6dd721f0${_scopeId}><!--[-->`);
                  ssrRenderList(assistantMeta(msg).follow_up_options, (option) => {
                    _push2(`<button type="button" class="ne-izlesem__followup-btn" data-v-6dd721f0${_scopeId}>${ssrInterpolate(option)}</button>`);
                  });
                  _push2(`<!--]--></div>`);
                } else {
                  _push2(`<!---->`);
            ...
            _push2(`<!--]-->`);
            if (isLoading.value) {
              _push2(`<div class="ne-izlesem__msg ne-izlesem__msg--ai" data-v-6dd721f0${_scopeId}><div class="ne-izlesem__msg-avatar" data-v-6dd721f0${_scopeId}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-v-6dd721f0${_scopeId}><path d="M15.91 11.72a.5.5 0 010 .56l-1.2 2.08a.5.5 0 01-.43.25H12.6a.5.5 0 01-.44-.25l-1.2-2.08a.5.5 0 010-.56l1.2-2.08a.5.5 0 01.44-.25h1.68a.5.5 0 01.43.25l1.2 2.08z" data-v-6dd721f0${_scopeId}></path><circle cx="12" cy="12" r="10" data-v-6dd721f0${_scopeId}></circle></svg></div><div class="ne-izlesem__msg-bubble" data-v-6dd721f0${_scopeId}><div class="ne-izlesem__loading-wrap" data-v-6dd721f0${_scopeId}><div class="ne-izlesem__loading-label" data-v-6dd721f0${_scopeId}>${ssrInterpolate(waitingLabel.value)}</div><div class="ne-izlesem__loading-svg" aria-hidden="true" data-v-6dd721f0${_scopeId}><svg viewBox="0 0 120 24" fill="none" data-v-6dd721f0${_scopeId}><rect x="2" y="5" width="26" height="14" rx="1.5" data-v-6dd721f0${_scopeId}></rect><rect x="34" y="5" width="26" height="14" rx="1.5" data-v-6dd721f0${_scopeId}></rect><rect x="66" y="5" width="26" height="14" rx="1.5" data-v-6dd721f0${_scopeId}></rect><path d="M98 12H118" stroke-linecap="square" data-v-6dd721f0${_scopeId}></path></svg></div><div class="ne-izlesem__typing" data-v-6dd721f0${_scopeId}><span data-v-6dd721f0${_scopeId}></span><span data-v-6dd721f0${_scopeId}></span><span data-v-6dd721f0${_scopeId}></span></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><button class="ne-izlesem__scroll-top" aria-label="Basa don" style="${ssrRenderStyle(showScrollTop.value ? null : { display: "none" })}" data-v-6dd721f0${_scopeId}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-v-6dd721f0${_scopeId}><polyline points="18 15 12 9 6 15" data-v-6dd721f0${_scopeId}></polyline></svg></button>`);
            if (error.value) {
              _push2(`<div class="ne-izlesem__error" data-v-6dd721f0${_scopeId}>${ssrInterpolate(error.value)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<form class="ne-izlesem__form" data-v-6dd721f0${_scopeId}><input${ssrRenderAttr("value", input.value)} type="text" placeholder="Ruh halini veya ne izlemek istediğini yaz..." maxlength="500"${ssrIncludeBooleanAttr(isLoading.value) ? " disabled" : ""} class="ne-izlesem__input" data-v-6dd721f0${_scopeId}><button type="submit"${ssrIncludeBooleanAttr(isLoading.value || !input.value.trim()) ? " disabled" : ""} class="ne-izlesem__send" data-v-6dd721f0${_scopeId}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-6dd721f0${_scopeId}><line x1="22" y1="2" x2="11" y2="13" data-v-6dd721f0${_scopeId}></line><polygon points="22 2 15 22 11 13 2 9 22 2" data-v-6dd721f0${_scopeId}></polygon></svg><span data-v-6dd721f0${_scopeId}>Gönder</span></button></form></div></div></div></div>`);
          } else {
            return [
                ...
                createVNode("header", { class: "ne-izlesem__header" }, [
                  createVNode("div", { class: "ne-izlesem__header-inner" }, [
                    ...
                    createVNode("p", { class: "ne-izlesem__subtitle" }, [
                      ...
                      createVNode("span", { class: "ne-izlesem__badge" }, "Vertex AI")
                    ])
                  ])
                ]),
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6dd721f0"]]);
export {
  Index as default
};
