import { ref, reactive, mergeProps, withCtx, unref, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, Fragment, renderList, createCommentVNode, Teleport, withModifiers, withDirectives, vModelText, useSSRContext } from "vue";
          ...
          if (_push2) {
            ...
            ssrRenderTeleport(_push2, (_push3) => {
              if (showPasswordModal.value) {
                _push3(`<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50"${_scopeId}><div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4 p-6"${_scopeId}><h3 class="text-lg font-bold text-gray-900 mb-4"${_scopeId}>Şifre Ata: ${ssrInterpolate(passwordForm.email)}</h3><form class="space-y-4"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Yeni Şifre</label><input${ssrRenderAttr("value", passwordForm.password)} type="password" required minlength="10" placeholder="En az 10 karakter" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-red-500"${_scopeId}></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Şifre Tekrarı</label><input${ssrRenderAttr("value", passwordForm.password_confirmation)} type="password" required minlength="10" placeholder="Şifreyi tekrar girin" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-red-500"${_scopeId}></div><div class="flex gap-2 justify-end"${_scopeId}><button type="button" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors"${_scopeId}> İptal </button><button type="submit" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors"${_scopeId}> Kaydet </button></div></form></div></div>`);
              } else {
                _push3(`<!---->`);
              }
            }, "body", false, _parent2);
            ...
            return [
              ...
              (openBlock(), createBlock(Teleport, { to: "body" }, [
                showPasswordModal.value ? (openBlock(), createBlock("div", {
                  ...
                  onClick: withModifiers(($event) => showPasswordModal.value = false, ["self"])
                }, [
                  createVNode("div", { class: "bg-white rounded-lg shadow-xl w-full max-w-md mx-4 p-6" }, [
                    createVNode("h3", { class: "text-lg font-bold text-gray-900 mb-4" }, "Şifre Ata: " + toDisplayString(passwordForm.email), 1),
                    createVNode("form", {
                      ...
                      createVNode("div", null, [
                        ...
                        withDirectives(createVNode("input", {
                          ...
                          [vModelText, passwordForm.password]
                        ])
                      ]),
                      createVNode("div", null, [
                        createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Şifre Tekrarı"),
                        withDirectives(createVNode("input", {
                          "onUpdate:modelValue": ($event) => passwordForm.password_confirmation = $event,
                          type: "password",
                          required: "",
                          minlength: "10",
                          ...
                          [vModelText, passwordForm.password_confirmation]
                        ])
                      ]),
