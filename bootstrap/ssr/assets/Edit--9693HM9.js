import { ref, computed, watch, onMounted, onBeforeUnmount, mergeProps, withCtx, unref, openBlock, createBlock, createVNode, createTextVNode, createCommentVNode, toDisplayString, withDirectives, Fragment, renderList, vModelSelect, withModifiers, vModelText, vModelCheckbox, useSSRContext } from "vue";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (serverDraftStatus.value !== "idle" || serverDraftSavedAt.value) {
              ...
              _push2(`<span${_scopeId}>#${ssrInterpolate(__props.post.id)}</span></div>`);
            } else {
              _push2(`<!---->`);
            }
              ...
              createVNode("div", { class: "mx-auto max-w-5xl space-y-6" }, [
                ...
                createVNode("form", {
                  ...
                  serverDraftStatus.value !== "idle" || serverDraftSavedAt.value ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("span", null, "#" + toDisplayString(__props.post.id), 1)
                  ])) : createCommentVNode("", true),
                  createVNode("div", null, [
                  ...
                  createVNode("div", null, [
                    ...
                    createVNode(_sfc_main$3, {
                      ...
                      "show-restore-banner": false,
                      "onUpdate:readingTime": onReadingTimeUpdate
                    }, null, 8, ["modelValue", "onUpdate:modelValue", "autosave-key"]),
