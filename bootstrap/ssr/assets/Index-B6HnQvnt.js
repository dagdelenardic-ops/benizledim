import { ref, onMounted, onUnmounted, mergeProps, withCtx, unref, createVNode, openBlock, createBlock, TransitionGroup, Fragment, renderList, withDirectives, toDisplayString, vShow, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AppLayout, mergeProps({ title: "İstanbul Film Festivali" }, _attrs), {
