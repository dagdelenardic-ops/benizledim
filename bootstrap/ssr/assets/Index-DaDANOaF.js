import { computed, withCtx, unref, createTextVNode, toDisplayString, openBlock, createBlock, createVNode, Fragment, renderList, createCommentVNode, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrRenderList } from "vue/server-renderer";
import { usePage, Link } from "@inertiajs/vue3";
import { a as _export_sfc, A as AppLayout } from "./AppLayout-DRxfLCYb.js";
import { _ as _sfc_main$1 } from "./PostGrid-CaCaEnTH.js";
import "@headlessui/vue";
import "axios";
import "./PostCard-C09KKzTl.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AppLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="min-h-screen bg-[var(--bi-paper)]" data-v-4174a087${_scopeId}><div class="border-b-2 border-[var(--bi-ink)]" data-v-4174a087${_scopeId}><div class="bi-wrap py-8" data-v-4174a087${_scopeId}><span class="bi-kicker" data-v-4174a087${_scopeId}>Arşiv</span><h1 class="bi-serif mt-3 text-5xl font-bold leading-none text-[var(--bi-ink)] md:text-7xl" data-v-4174a087${_scopeId}>${ssrInterpolate(heading.value)}</h1><p class="mt-4 max-w-2xl text-[var(--bi-muted)]" data-v-4174a087${_scopeId}> Film, dizi ve belgesel dünyasından eleştiri ve tavsiyeler </p></div></div><div class="sticky top-0 z-10 border-b border-[var(--bi-ink)] bg-[var(--bi-paper)]/95 backdrop-blur" data-v-4174a087${_scopeId}><div class="bi-wrap py-4" data-v-4174a087${_scopeId}><div class="flex items-center gap-2 overflow-x-auto pb-2 scrollbar-hide" data-v-4174a087${_scopeId}>`);
            ...
            if (__props.filters.category || __props.filters.tag) {
              _push2(`<div class="mt-4" data-v-4174a087${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: "/yazilar",
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(` Filtreyi Temizle <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-4174a087${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-4174a087${_scopeId2}></path></svg>`);
                  } else {
                    return [
            ...
            _push2(`</div></div><div class="bi-wrap py-8" data-v-4174a087${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1, {
              posts: __props.posts.data
            }, null, _parent2, _scopeId));
            if (__props.posts.data.length === 0) {
              _push2(`<div class="bi-rule-box mt-6 text-center py-16" data-v-4174a087${_scopeId}><svg class="w-16 h-16 mx-auto text-[var(--bi-rule-soft)] mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-4174a087${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-4174a087${_scopeId}></path></svg><h3 class="bi-serif text-3xl font-bold text-[var(--bi-ink)] mb-2" data-v-4174a087${_scopeId}>Sonuç bulunamadı</h3><p class="text-[var(--bi-muted)]" data-v-4174a087${_scopeId}>Seçtiğiniz kriterlere uygun yazı bulunmuyor.</p>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: "/yazilar",
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(` Tüm yazıları gör <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-4174a087${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" data-v-4174a087${_scopeId2}></path></svg>`);
                  } else {
                    return [
            ...
            if (__props.posts.links && __props.posts.data.length > 0) {
              _push2(`<div class="mt-12 flex justify-center" data-v-4174a087${_scopeId}><div class="flex items-center gap-2" data-v-4174a087${_scopeId}><!--[-->`);
              ...
              createVNode("div", { class: "min-h-screen bg-[var(--bi-paper)]" }, [
                createVNode("div", { class: "border-b-2 border-[var(--bi-ink)]" }, [
                  createVNode("div", { class: "bi-wrap py-8" }, [
                    ...
                    createVNode("h1", { class: "bi-serif mt-3 text-5xl font-bold leading-none text-[var(--bi-ink)] md:text-7xl" }, toDisplayString(heading.value), 1),
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4174a087"]]);
export {
  Index as default
};
