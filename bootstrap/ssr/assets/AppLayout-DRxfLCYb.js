import { ref, reactive, computed, watch, unref, mergeProps, withCtx, createVNode, createTextVNode, openBlock, createBlock, toDisplayString, createCommentVNode, Fragment, withModifiers, withDirectives, vModelText, useSSRContext, onBeforeUnmount, onMounted, onUnmounted, resolveDirective, renderList, resolveDynamicComponent } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderAttr, ssrRenderClass, ssrRenderList, ssrRenderAttrs, ssrRenderTeleport, ssrRenderVNode, ssrGetDirectiveProps, ssrRenderSlot } from "vue/server-renderer";
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><form class="relative hidden md:block"><input${ssrRenderAttr("value", searchQuery.value)} type="text"${ssrRenderAttr("placeholder", __props.placeholder)} autocomplete="off" class="min-h-11 w-72 border border-[var(--bi-ink)] bg-transparent py-2.5 pl-10 pr-4 text-sm text-[var(--bi-ink)] placeholder-[var(--bi-muted)] transition-all focus:border-red-700 focus:outline-none"><svg class="absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-red-700" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>`);
      if (showSuggestions.value) {
        _push(`<ul class="absolute left-0 right-0 top-full z-40 mt-1 max-h-80 overflow-auto border border-[var(--bi-ink)] bg-white shadow-lg"><!--[-->`);
        ssrRenderList(suggestions.value, (s, i) => {
          _push(`<li class="${ssrRenderClass([
            "cursor-pointer px-4 py-2 text-sm",
            highlight.value === i ? "bg-red-50 text-red-700" : "text-gray-800 hover:bg-gray-50"
          ])}">${ssrInterpolate(s)}</li>`);
        });
        _push(`<!--]--></ul>`);
      } else {
      ...
      _push(`</form><div class="md:hidden"><button class="inline-flex h-11 w-11 items-center justify-center border border-[var(--bi-ink)] text-[var(--bi-ink)] transition-colors hover:bg-[var(--bi-ink)] hover:text-[var(--bi-paper)]" aria-label="Aramayı aç"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg></button>`);
      if (isOpen.value) {
        _push(`<div class="fixed inset-0 z-50 bg-black/50"><div class="border-b-2 border-[var(--bi-ink)] bg-[var(--bi-paper)] p-4"><form class="relative"><input id="mobile-search-input"${ssrRenderAttr("value", searchQuery.value)} type="text" placeholder="Yazı ara..." autocomplete="off" class="min-h-12 w-full border border-[var(--bi-ink)] bg-white py-3 pl-10 pr-12 text-gray-900 placeholder-gray-500 focus:outline-none"><svg class="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg><button type="button" class="absolute right-2 top-1/2 inline-flex h-9 w-9 -translate-y-1/2 items-center justify-center text-gray-400 hover:text-gray-600" aria-label="Aramayı kapat"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></form>`);
        if (showSuggestions.value) {
          _push(`<ul class="mt-2 max-h-72 overflow-auto border border-[var(--bi-ink)] bg-white"><!--[-->`);
          ssrRenderList(suggestions.value, (s, i) => {
            _push(`<li class="cursor-pointer px-4 py-3 text-sm text-gray-800 hover:bg-red-50 hover:text-red-700 border-b last:border-b-0">${ssrInterpolate(s)}</li>`);
          });
          _push(`<!--]--></ul>`);
        } else {
          _push(`<!---->`);
...
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="flex items-center justify-around h-16 px-1">`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              createVNode("span", { class: "text-[10px] font-medium" }, "Ana Sayfa")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"${_scopeId}></path></svg><span class="text-[10px] font-medium"${_scopeId}>Keşfet</span>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                class: "w-5 h-5",
              ...
              createVNode("span", { class: "text-[10px] font-medium" }, "Keşfet")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<button type="button" class="relative flex flex-col items-center justify-center gap-0.5 min-w-0 flex-1 h-full -mt-5"><div class="flex h-12 w-12 items-center justify-center rounded-full bg-red-600 text-white shadow-lg active:bg-red-700 transition-colors"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 4v16m8-8H4"></path></svg></div><span class="text-[10px] font-medium text-red-700">İncele</span></button>`);
      _push(ssrRenderComponent(unref(Link), {
        href: "/haberler",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"${_scopeId}></path></svg><span class="text-[10px] font-medium"${_scopeId}>Haberler</span>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                class: "w-5 h-5",
              ...
              createVNode("span", { class: "text-[10px] font-medium" }, "Haberler")
            ];
          }
        }),
        _: 1
      ...
      if (authUser.value) {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (authUser.value.avatar) {
                _push2(`<img${ssrRenderAttr("src", authUser.value.avatar)} class="w-5 h-5 rounded-full object-cover"${_scopeId}>`);
              } else {
                _push2(`<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"${_scopeId}></path></svg>`);
              }
              _push2(`<span class="text-[10px] font-medium"${_scopeId}>Profil</span>`);
            } else {
              return [
                authUser.value.avatar ? (openBlock(), createBlock("img", {
                  key: 0,
                ...
                createVNode("span", { class: "text-[10px] font-medium" }, "Profil")
              ];
            }
          }),
          _: 1
        ...
        _push(`<button type="button" class="relative flex flex-col items-center justify-center gap-0.5 min-w-0 flex-1 h-full text-gray-500"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg><span class="text-[10px] font-medium">Giriş</span></button>`);
      }
      _push(`</div></nav>`);
    };
  }
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Layout/MobileBottomNav.vue");
...
const dismissWindowMs = 7 * 24 * 60 * 60 * 1e3;
const visibilityDelayMs$1 = 5e3;
const _sfc_main$2 = {
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    const fullTitle = computed(() => resolvedTitle.value ? `${resolvedTitle.value} - Ben İzledim` : "Ben İzledim - Film, Dizi ve Belgesel Eleştiri Platformu");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title data-v-d02ce7a3${_scopeId}>${ssrInterpolate(fullTitle.value)}</title><link rel="canonical"${ssrRenderAttr("href", currentCanonical.value)} data-v-d02ce7a3${_scopeId}><link rel="alternate" type="application/rss+xml" title="Ben İzledim RSS" href="https://benizledim.com/feed" data-v-d02ce7a3${_scopeId}><meta name="description"${ssrRenderAttr("content", resolvedDescription.value)} data-v-d02ce7a3${_scopeId}><meta name="robots"${ssrRenderAttr("content", resolvedRobots.value)} data-v-d02ce7a3${_scopeId}><meta name="googlebot"${ssrRenderAttr("content", resolvedRobots.value)} data-v-d02ce7a3${_scopeId}><meta property="og:title"${ssrRenderAttr("content", fullTitle.value)} data-v-d02ce7a3${_scopeId}><meta property="og:description"${ssrRenderAttr("content", resolvedDescription.value)} data-v-d02ce7a3${_scopeId}><meta property="og:image"${ssrRenderAttr("content", fullOgImage.value)} data-v-d02ce7a3${_scopeId}><meta property="og:url"${ssrRenderAttr("content", currentCanonical.value)} data-v-d02ce7a3${_scopeId}><meta property="og:type"${ssrRenderAttr("content", __props.ogType)} data-v-d02ce7a3${_scopeId}><meta property="og:site_name" content="Ben İzledim" data-v-d02ce7a3${_scopeId}><meta property="og:locale" content="tr_TR" data-v-d02ce7a3${_scopeId}><!--[-->`);
            ssrRenderList(__props.extraMeta, (meta, index) => {
              ...
              }))} data-v-d02ce7a3${_scopeId}>`);
            });
            _push2(`<!--]--><meta name="twitter:card" content="summary_large_image" data-v-d02ce7a3${_scopeId}><meta name="twitter:title"${ssrRenderAttr("content", fullTitle.value)} data-v-d02ce7a3${_scopeId}><meta name="twitter:description"${ssrRenderAttr("content", resolvedDescription.value)} data-v-d02ce7a3${_scopeId}><meta name="twitter:image"${ssrRenderAttr("content", fullOgImage.value)} data-v-d02ce7a3${_scopeId}>`);
          } else {
            return [
      ...
      _push(`<!--]--><a href="#ana-icerik" class="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[100] focus:rounded focus:bg-red-700 focus:px-4 focus:py-2 focus:text-sm focus:font-bold focus:text-white focus:shadow-lg" data-v-d02ce7a3> İçeriğe atla </a><header class="border-b-2 border-[var(--bi-ink)] bg-[var(--bi-paper)]" data-v-d02ce7a3><div class="bg-[var(--bi-ink)] text-[var(--bi-paper)]" data-v-d02ce7a3><div class="bi-wrap flex h-8 items-center justify-between gap-4 text-[0.68rem] font-bold uppercase tracking-[0.08em] bi-mono" data-v-d02ce7a3><span data-v-d02ce7a3>${ssrInterpolate(todayLabel.value)} · İstanbul</span><div class="hidden items-center gap-4 sm:flex" data-v-d02ce7a3>`);
      _push(ssrRenderComponent(unref(Link), {
        href: "/#bulten",
      ...
      if (!authUser.value) {
        _push(`<button class="inline-flex items-center py-2 hover:text-red-300" data-v-d02ce7a3>Giriş</button>`);
      ...
      _push(`</div></div></div><div class="bi-wrap grid gap-5 border-b border-[var(--bi-ink)] py-5 lg:grid-cols-[auto_1fr_auto] lg:items-end" data-v-d02ce7a3><button class="inline-flex h-11 w-11 items-center justify-center border border-[var(--bi-ink)] lg:hidden" aria-label="Menüyü aç" data-v-d02ce7a3>`);
      if (!showMobileMenu.value) {
        _push(`<svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d02ce7a3><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7h16M4 17h16" data-v-d02ce7a3></path></svg>`);
      } else {
        _push(`<svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d02ce7a3><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-d02ce7a3></path></svg>`);
      }
      _push(`</button>`);
      _push(ssrRenderComponent(unref(Link), {
        href: "/",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Ben<span class="px-1 text-red-700" data-v-d02ce7a3${_scopeId}>/</span>İzledim `);
          } else {
            return [
              createTextVNode(" Ben"),
      ...
      _push(`<p class="hidden max-w-[24ch] border-l border-[var(--bi-ink)] pl-4 text-xs font-bold uppercase leading-5 tracking-[0.08em] text-[var(--bi-muted)] bi-mono lg:block" data-v-d02ce7a3> Film, dizi ve belgesel üzerine bağımsız eleştiri </p><div class="flex flex-wrap items-center gap-3 lg:justify-end" data-v-d02ce7a3>`);
      _push(ssrRenderComponent(unref(Link), {
        href: "/quiz",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="quiz-cta-emoji" data-v-d02ce7a3${_scopeId}>🎭</span><span data-v-d02ce7a3${_scopeId}>Quiz</span>`);
          } else {
            return [
      ...
      _push(`<button type="button" class="hidden min-h-11 items-center border border-red-700 bg-red-700 px-4 py-2 text-sm font-bold text-white transition hover:bg-red-800 md:inline-flex" data-v-d02ce7a3> Hemen İncele </button>`);
      _push(ssrRenderComponent(_sfc_main$5, { placeholder: "Film, dizi, yazar ara..." }, null, _parent));
      if (!authUser.value) {
        _push(`<button class="hidden min-h-11 items-center border border-[var(--bi-ink)] bg-[var(--bi-ink)] px-4 py-2 text-sm font-bold text-[var(--bi-paper)] transition hover:bg-red-700 md:inline-flex" data-v-d02ce7a3> Giriş </button>`);
      } else {
        _push(`<div class="relative hidden md:block" data-v-d02ce7a3><button class="flex min-h-11 items-center gap-2 border border-[var(--bi-ink)] bg-[var(--bi-paper)] px-3 py-2 text-sm font-bold" data-v-d02ce7a3>`);
        if (authUser.value.avatar) {
          _push(`<img${ssrRenderAttr("src", authUser.value.avatar)}${ssrRenderAttr("alt", authUser.value.name)} class="h-7 w-7 rounded-full object-cover" data-v-d02ce7a3>`);
        } else {
          _push(`<span class="flex h-7 w-7 items-center justify-center rounded-full bg-red-700 text-white" data-v-d02ce7a3>${ssrInterpolate(authUser.value?.name?.charAt(0)?.toUpperCase() || "?")}</span>`);
        }
        _push(`<span class="max-w-32 truncate" data-v-d02ce7a3>${ssrInterpolate(authUser.value.name)}</span></button>`);
        if (showUserMenu.value) {
          _push(`<div${ssrRenderAttrs(mergeProps({ class: "absolute right-0 z-50 mt-2 w-52 border border-[var(--bi-ink)] bg-[var(--bi-paper)] py-1 shadow-[6px_6px_0_var(--bi-ink)]" }, ssrGetDirectiveProps(_ctx, _directive_click_outside, () => showUserMenu.value = false)))} data-v-d02ce7a3><button class="flex min-h-11 w-full items-center gap-2 px-4 py-2 text-left text-sm font-bold text-red-700 hover:bg-[var(--bi-paper-deep)]" data-v-d02ce7a3><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d02ce7a3><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" data-v-d02ce7a3></path></svg> Hızlı Not </button>`);
          if (canAccessCms.value) {
            _push(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d02ce7a3${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" data-v-d02ce7a3${_scopeId}></path></svg> Yeni Yazı `);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      class: "h-4 w-4",
          ...
          _push(`<button class="flex min-h-11 w-full items-center px-4 py-2 text-left text-sm hover:bg-[var(--bi-paper-deep)]" data-v-d02ce7a3>Çıkış Yap</button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      }
      _push(`</div></div><nav class="bi-wrap hidden h-12 items-stretch justify-between border-b border-[var(--bi-ink)] lg:flex" data-v-d02ce7a3><div class="flex" data-v-d02ce7a3>`);
      _push(ssrRenderComponent(unref(Link), {
        href: "/",
      ...
      _push(`</div><div class="flex items-stretch" data-v-d02ce7a3>`);
      _push(ssrRenderComponent(unref(Link), {
        href: "/quiz",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="quiz-cta-emoji" data-v-d02ce7a3${_scopeId}>🎭</span><span data-v-d02ce7a3${_scopeId}>Hangi Karaktersin?</span>`);
          } else {
            return [
              createVNode("span", { class: "quiz-cta-emoji" }, "🎭"),
      ...
      _push(`</div></nav>`);
      if (showMobileMenu.value) {
        _push(`<div class="bi-wrap border-b border-[var(--bi-ink)] py-4 lg:hidden" data-v-d02ce7a3><div class="grid gap-2" data-v-d02ce7a3>`);
        _push(ssrRenderComponent(unref(Link), {
          href: "/",
          class: "bi-chip",
        ...
        if (!authUser.value) {
          _push(`<button class="bi-chip text-left" data-v-d02ce7a3>Giriş Yap</button>`);
        } else {
          _push(`<!--[--><button class="bi-chip bi-chip--accent text-left" data-v-d02ce7a3>Hemen İncele</button>`);
          _push(ssrRenderComponent(unref(Link), {
            href: "/yazar",
            class: "bi-chip",
            onClick: ($event) => showMobileMenu.value = false
      ...
      _push(`</header><main id="ana-icerik" class="min-h-screen pb-20 lg:pb-0" data-v-d02ce7a3>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</main><footer class="border-t-2 border-[var(--bi-ink)] bg-[var(--bi-ink)] text-[var(--bi-paper)]" data-v-d02ce7a3><div class="bi-wrap py-12" data-v-d02ce7a3><div class="grid grid-cols-1 gap-8 md:grid-cols-[1.2fr_0.8fr_1fr]" data-v-d02ce7a3><div id="bulten" data-v-d02ce7a3><h3 class="bi-serif mb-4 text-4xl font-bold" data-v-d02ce7a3>Ben/İzledim</h3><p class="max-w-md text-sm leading-relaxed text-stone-300" data-v-d02ce7a3> Film, Dizi ve Belgeseller hakkında eleştiri ve tavsiye yazılarının yer aldığı bir medya ve eğlence platformudur. </p></div><div data-v-d02ce7a3><h4 class="bi-mono mb-4 text-xs font-bold uppercase tracking-[0.08em] text-red-300" data-v-d02ce7a3>Kategoriler</h4><ul class="space-y-2 text-sm" data-v-d02ce7a3><li data-v-d02ce7a3>`);
      _push(ssrRenderComponent(unref(Link), {
        href: "/yazilar/sinema",
      ...
      _push(`</li></ul></div><div data-v-d02ce7a3><h4 class="bi-mono mb-4 text-xs font-bold uppercase tracking-[0.08em] text-red-300" data-v-d02ce7a3>Önce Siz Okuyun</h4><p class="mb-4 text-sm text-stone-300" data-v-d02ce7a3> Yeni blog yazılarımızdan ve haberlerden ilk siz haberdar olun! </p>`);
      if (newsletterMessage.value) {
        _push(`<div class="mb-3" data-v-d02ce7a3><div class="border border-green-200 bg-green-100 px-3 py-2 text-sm text-green-700" data-v-d02ce7a3>${ssrInterpolate(newsletterMessage.value)}</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<form class="flex gap-2" novalidate data-v-d02ce7a3><input${ssrRenderAttr("value", unref(form).email)} type="email" placeholder="E-posta adresiniz" class="${ssrRenderClass([{ "border-red-500": unref(form).errors.email }, "min-w-0 flex-1 border border-stone-500 bg-transparent px-3 py-2 text-sm text-white placeholder-stone-400 focus:border-red-400 focus:outline-none"])}" data-v-d02ce7a3><button type="submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="bg-red-700 px-4 py-2 text-sm font-bold text-white transition-colors hover:bg-red-800 disabled:opacity-50" data-v-d02ce7a3> Abone </button></form>`);
      if (unref(form).errors.email) {
        _push(`<p class="mt-2 text-red-400 text-xs" data-v-d02ce7a3>${ssrInterpolate(unref(form).errors.email)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="bi-mono mt-8 border-t border-stone-700 pt-8 text-center text-xs uppercase tracking-[0.08em] text-stone-500" data-v-d02ce7a3> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} Ben İzledim. Tüm hakları saklıdır. </div></div></footer>`);
...
const AppLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d02ce7a3"]]);
export {
  AppLayout as A,
  _sfc_main$6 as _,
  _export_sfc as a,
