import { mergeProps, unref, withCtx, createTextVNode, createVNode, openBlock, createBlock, toDisplayString, useSSRContext, computed, Fragment, renderList, createCommentVNode, withModifiers, withDirectives, vModelText } from "vue";
...
import { _ as _sfc_main$2 } from "./PostGrid-CaCaEnTH.js";
import { b as buildResponsiveImage } from "./PostCard-C09KKzTl.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.items.length) {
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                createTextVNode(" Tüm haberler → ")
              ];
            }
          }),
          _: 1
        }, _parent));
        _push(`</div><div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4"><!--[-->`);
        ...
        _push(`<!--]--></div><div class="mt-6 flex justify-center md:hidden">`);
        _push(ssrRenderComponent(unref(Link), {
          href: "/haberler",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AppLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="border-b-2 border-[var(--bi-ink)] bg-[var(--bi-paper)]" data-v-d190f609${_scopeId}>`);
            if (featuredPost.value) {
              _push2(`<div class="bi-wrap py-5" data-v-d190f609${_scopeId}><div class="grid gap-5" data-v-d190f609${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="relative h-[150px] overflow-hidden border-b border-[var(--bi-ink)] bg-[var(--bi-ink)] md:h-[174px] lg:h-[190px]" data-v-d190f609${_scopeId2}>`);
                    if (featuredPost.value.cover_image) {
                      _push3(`<img${ssrRenderAttr("src", featuredImage.value.src)}${ssrRenderAttr("srcset", featuredImage.value.srcset || void 0)}${ssrRenderAttr("sizes", featuredImage.value.sizes || void 0)}${ssrRenderAttr("alt", featuredPost.value.title)} style="${ssrRenderStyle(coverImageStyle(featuredPost.value))}" class="featured-hero-image h-full w-full object-cover opacity-95 transition duration-500 group-hover:scale-105" loading="eager" fetchpriority="high" decoding="async" width="1600" height="900" data-v-d190f609${_scopeId2}>`);
                    } else {
                      _push3(`<div class="grid h-full place-items-center text-7xl font-bold text-[var(--bi-paper)] bi-serif" data-v-d190f609${_scopeId2}> Bİ </div>`);
                    }
                    _push3(`<div class="absolute bottom-0 left-0 border-r border-t border-[var(--bi-ink)] bg-[var(--bi-paper)] px-4 py-3" data-v-d190f609${_scopeId2}><span class="block text-3xl font-bold leading-none bi-serif" data-v-d190f609${_scopeId2}>Manşet</span><span class="block text-[0.65rem] font-bold uppercase tracking-[0.08em] text-[var(--bi-muted)] bi-mono" data-v-d190f609${_scopeId2}>Bu haftanın yazısı</span></div></div><div class="relative flex flex-col p-5 md:p-6" data-v-d190f609${_scopeId2}><div data-v-d190f609${_scopeId2}><div class="flex items-start justify-between gap-4" data-v-d190f609${_scopeId2}><div data-v-d190f609${_scopeId2}><span class="bi-kicker" data-v-d190f609${_scopeId2}>${ssrInterpolate(firstCategoryName(featuredPost.value))}</span><h1 class="bi-serif mt-3 max-w-4xl text-[clamp(2rem,4.2vw,3.9rem)] font-bold leading-[0.96] text-[var(--bi-ink)]" data-v-d190f609${_scopeId2}>${ssrInterpolate(featuredPost.value.title)}</h1></div><span class="hidden text-6xl font-bold leading-none text-black/5 bi-serif md:block" data-v-d190f609${_scopeId2}>01</span></div><p class="mt-4 max-w-2xl text-sm leading-6 text-[var(--bi-muted)] md:text-base md:leading-7" data-v-d190f609${_scopeId2}>${ssrInterpolate(featuredPost.value.excerpt)}</p></div><div class="mt-5 flex flex-wrap items-center gap-3" data-v-d190f609${_scopeId2}><span class="inline-flex items-center gap-3 bg-[var(--bi-ink)] px-5 py-3 text-sm font-bold uppercase tracking-[0.08em] text-[var(--bi-paper)] transition group-hover:bg-red-700 bi-mono" data-v-d190f609${_scopeId2}> Yazıyı oku <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d190f609${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14M13 6l6 6-6 6" data-v-d190f609${_scopeId2}></path></svg></span><div class="text-xs uppercase tracking-[0.08em] text-[var(--bi-muted)] bi-mono" data-v-d190f609${_scopeId2}>${ssrInterpolate(featuredPost.value.user?.name || "Ben İzledim")} <span class="mx-2 text-black/20" data-v-d190f609${_scopeId2}>/</span> ${ssrInterpolate(formatReadingTime(featuredPost.value.reading_time_minutes))}</div></div></div>`);
                  } else {
                    return [
              ...
              _push2(`<div class="bi-wrap py-16" data-v-d190f609${_scopeId}><div class="bi-rule-box p-8 text-center" data-v-d190f609${_scopeId}><h1 class="bi-serif text-5xl font-bold" data-v-d190f609${_scopeId}>Ben İzledim</h1><p class="mt-4 text-[var(--bi-muted)]" data-v-d190f609${_scopeId}>Yazılar hazırlanıyor.</p></div></div>`);
            }
            _push2(`</section>`);
            _push2(ssrRenderComponent(_sfc_main$1, { items: __props.flashNews }, null, _parent2, _scopeId));
            _push2(`<section class="bi-wrap grid gap-8 py-8 lg:grid-cols-[1fr_320px]" data-v-d190f609${_scopeId}><div data-v-d190f609${_scopeId}><div class="mb-6 flex items-end justify-between border-b border-[var(--bi-ink)] pb-4" data-v-d190f609${_scopeId}><div data-v-d190f609${_scopeId}><span class="bi-kicker" data-v-d190f609${_scopeId}>01</span><h2 class="bi-serif mt-2 text-4xl font-bold text-[var(--bi-ink)] md:text-5xl" data-v-d190f609${_scopeId}>Son Yazılar</h2></div>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: "/yazilar",
            ...
            _push2(`</div><aside class="h-fit border border-[var(--bi-ink)] bg-[var(--bi-paper-deep)]" data-v-d190f609${_scopeId}><div class="border-b border-[var(--bi-ink)] bg-[var(--bi-ink)] px-4 py-3 text-xs font-bold uppercase tracking-[0.08em] text-[var(--bi-paper)] bi-mono" data-v-d190f609${_scopeId}> En Yeni </div><!--[-->`);
            ssrRenderList(railPosts.value, (post, index) => {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<span class="text-3xl font-bold leading-none text-red-700 bi-serif" data-v-d190f609${_scopeId2}>${ssrInterpolate(String(index + 1).padStart(2, "0"))}</span><span data-v-d190f609${_scopeId2}><span class="bi-mono block text-[0.65rem] font-bold uppercase tracking-[0.08em] text-[var(--bi-muted)]" data-v-d190f609${_scopeId2}>${ssrInterpolate(firstCategoryName(post))}</span><span class="bi-serif mt-1 block text-xl font-bold leading-tight" data-v-d190f609${_scopeId2}>${ssrInterpolate(post.title)}</span></span>`);
                  } else {
                    return [
            ...
            _push2(`<!--]--></aside></section><section class="border-y border-[var(--bi-ink)] bg-[var(--bi-paper-deep)]" data-v-d190f609${_scopeId}><div class="bi-wrap py-10" data-v-d190f609${_scopeId}><div class="mb-6 flex items-end justify-between gap-4 border-b border-[var(--bi-ink)] pb-4" data-v-d190f609${_scopeId}><div data-v-d190f609${_scopeId}><span class="bi-kicker" data-v-d190f609${_scopeId}>Aşağıda Daha Fazlası Var</span><h2 class="bi-serif mt-2 text-3xl font-bold text-[var(--bi-ink)] md:text-4xl" data-v-d190f609${_scopeId}>İncelemelerin Yanında Bunlar da Var</h2></div><span class="hidden text-xs font-bold uppercase tracking-[0.08em] text-[var(--bi-muted)] bi-mono md:block" data-v-d190f609${_scopeId}>Scroll ettikçe keşfet</span></div><div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3" data-v-d190f609${_scopeId}><!--[-->`);
            ssrRenderList(secondarySpotlights.value, (item) => {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div data-v-d190f609${_scopeId2}><span class="bi-kicker" data-v-d190f609${_scopeId2}>${ssrInterpolate(item.label)}</span><h3 class="bi-serif mt-3 text-3xl font-bold leading-tight text-[var(--bi-ink)]" data-v-d190f609${_scopeId2}>${ssrInterpolate(item.title)}</h3><p class="mt-3 text-sm leading-6 text-[var(--bi-muted)]" data-v-d190f609${_scopeId2}>${ssrInterpolate(item.description)}</p></div><div class="mt-6 flex items-end justify-between gap-3 border-t border-[var(--bi-rule-soft)] pt-4" data-v-d190f609${_scopeId2}><div class="text-xs font-bold uppercase tracking-[0.08em] text-red-700 bi-mono" data-v-d190f609${_scopeId2}>${ssrInterpolate(item.metric)}</div><span class="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-[0.08em] text-[var(--bi-ink)] bi-mono group-hover:text-red-700" data-v-d190f609${_scopeId2}>${ssrInterpolate(item.cta)} <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d190f609${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14M13 6l6 6-6 6" data-v-d190f609${_scopeId2}></path></svg></span></div>`);
                  } else {
                    return [
                      createVNode("div", null, [
            ...
            _push2(`<!--]--></div></div></section><section class="border-y-2 border-[var(--bi-ink)] bg-[var(--bi-ink)] text-[var(--bi-paper)]" data-v-d190f609${_scopeId}><div class="bi-wrap grid gap-8 py-12 md:grid-cols-[1fr_1.1fr] md:items-center" data-v-d190f609${_scopeId}><div data-v-d190f609${_scopeId}><span class="bi-mono text-xs font-bold uppercase tracking-[0.08em] text-red-300" data-v-d190f609${_scopeId}>Bülten</span><h2 class="bi-serif mt-2 text-4xl font-bold md:text-5xl" data-v-d190f609${_scopeId}>Önce Siz Okuyun</h2><p class="mt-4 max-w-xl text-stone-300" data-v-d190f609${_scopeId}> Yeni yazılar, festival notları ve izleme önerileri. Kısa, seçilmiş, gürültüsüz. </p></div><div data-v-d190f609${_scopeId}>`);
            if (newsletterMessage.value) {
              _push2(`<div class="mb-4 border border-green-200 bg-green-100 px-4 py-3 text-green-700" data-v-d190f609${_scopeId}>${ssrInterpolate(newsletterMessage.value)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<form class="flex flex-col gap-3 sm:flex-row" novalidate data-v-d190f609${_scopeId}><input${ssrRenderAttr("value", unref(form).email)} type="email" placeholder="E-posta adresiniz" class="${ssrRenderClass([{ "border-red-500": unref(form).errors.email }, "min-w-0 flex-1 border border-stone-500 bg-transparent px-4 py-3 text-white placeholder-stone-400 focus:border-red-400 focus:outline-none"])}" data-v-d190f609${_scopeId}><button type="submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="bg-red-700 px-6 py-3 font-bold text-white transition-colors hover:bg-red-800 disabled:opacity-50" data-v-d190f609${_scopeId}>`);
            if (unref(form).processing) {
              _push2(`<span data-v-d190f609${_scopeId}>Gönderiliyor...</span>`);
            } else {
              _push2(`<span data-v-d190f609${_scopeId}>Abone Ol</span>`);
            }
            _push2(`</button></form>`);
            if (unref(form).errors.email) {
              _push2(`<p class="mt-2 text-sm text-red-300" data-v-d190f609${_scopeId}>${ssrInterpolate(unref(form).errors.email)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></section><section class="border-t border-[var(--bi-rule-soft)] bg-[var(--bi-paper)]" data-v-d190f609${_scopeId}><div class="bi-wrap py-8" data-v-d190f609${_scopeId}><details class="border border-[var(--bi-rule-soft)] bg-[var(--bi-paper-deep)] open:bg-[var(--bi-paper)]" data-v-d190f609${_scopeId}><summary class="flex cursor-pointer list-none items-center justify-between gap-4 px-4 py-4 text-left" data-v-d190f609${_scopeId}><span data-v-d190f609${_scopeId}><span class="block text-[0.65rem] font-bold uppercase tracking-[0.08em] text-[var(--bi-muted)] bi-mono" data-v-d190f609${_scopeId}>İstersen bak</span><span class="bi-serif mt-1 block text-2xl font-bold text-[var(--bi-ink)]" data-v-d190f609${_scopeId}>Keşfet</span></span><span class="text-xs font-bold uppercase tracking-[0.08em] text-red-700 bi-mono" data-v-d190f609${_scopeId}>Kategorileri Aç</span></summary><div class="border-t border-[var(--bi-rule-soft)] px-4 py-4" data-v-d190f609${_scopeId}><div class="flex flex-wrap items-center gap-3" data-v-d190f609${_scopeId}><!--[-->`);
            ssrRenderList(__props.categories, (category) => {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(category.name)} <span class="text-current/60" data-v-d190f609${_scopeId2}>${ssrInterpolate(category.posts_count)}</span>`);
                  } else {
                    return [
...
const Home = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d190f609"]]);
export {
  Home as default
};
