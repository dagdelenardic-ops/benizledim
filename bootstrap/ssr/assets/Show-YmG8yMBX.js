...
import { a as _export_sfc, A as AppLayout, _ as _sfc_main$h } from "./AppLayout-Bunikqc4.js";
import { _ as _sfc_main$g, b as buildResponsiveImage } from "./PostCard-BwkqJ6T-.js";
...
const ArticleBody = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-c4199799"]]);
const _sfc_main$1 = {
      ...
      _push(ssrRenderComponent(AppLayout, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$f, { posts: __props.relatedPosts }, null, _parent2, _scopeId));
            _push2(`</div></article>`);
              ...
              createVNode("article", { class: "min-h-screen bg-white" }, [
                ...
                createVNode("div", { class: "max-w-6xl mx-auto px-4 -mt-32 relative z-10" }, [
                  createVNode("div", { class: "bg-white rounded-t-2xl md:rounded-2xl shadow-sm p-6 md:p-10" }, [
                    ...
                    __props.post.is_revisit || __props.post.revisits && __props.post.revisits.length > 0 ? (openBlock(), createBlock(_sfc_main$5, {
                      key: 0,
                      "original-post": __props.post.original_post,
                      revisits: __props.post.revisits || [],
                      "is-revisit": __props.post.is_revisit,
                    ...
                    ])) : __props.post.format === "dialogue" ? (openBlock(), createBlock(_sfc_main$4, {
                      key: 3,
                      exchanges: __props.post.dialogue_exchanges || [],
                      "primary-author": __props.post.user,
                      "secondary-author": __props.post.secondary_author,
                      intro: __props.post.content
                    }, null, 8, ["exchanges", "primary-author", "secondary-author", "intro"])) : __props.post.format === "visual_essay" ? (openBlock(), createBlock(_sfc_main$3, {
                      key: 4,
                      blocks: __props.post.visual_essay_blocks || []
                    ...
                    createVNode("div", { class: "mx-auto mt-8 flex max-w-[750px] flex-col gap-4 border-t border-gray-200 pt-8 sm:flex-row sm:items-center sm:justify-between" }, [
                      createVNode("div", { class: "flex items-center gap-3" }, [
                        ...
                        authUser.value ? (openBlock(), createBlock(_sfc_main$1, {
                          key: 0,
                          post: __props.post,
                          "initial-watchlisted": __props.isWatchlisted
                ...
                createVNode("div", { class: "max-w-7xl mx-auto px-4 py-12" }, [
                  createVNode(_sfc_main$f, { posts: __props.relatedPosts }, null, 8, ["posts"])
                ])
              ]),
