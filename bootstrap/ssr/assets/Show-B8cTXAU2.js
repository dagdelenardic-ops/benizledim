import { mergeProps, withCtx, unref, createVNode, openBlock, createBlock, toDisplayString, Fragment, renderList, createCommentVNode, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderClass, ssrRenderList } from "vue/server-renderer";
import { usePage, Link, router } from "@inertiajs/vue3";
import { A as AppLayout } from "./AppLayout-BbFbHk45.js";
import { _ as _sfc_main$2 } from "./PostGrid-XfxM0aNu.js";
import { _ as _sfc_main$1, a as _sfc_main$3 } from "./WatchLogCard-CjKvGqAo.js";
      ...
      _push(ssrRenderComponent(AppLayout, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div></div></div><div class="max-w-7xl mx-auto px-4 -mt-6"${_scopeId}>`);
              ...
              createVNode("div", { class: "min-h-screen bg-gray-50" }, [
                ...
                createVNode("div", { class: "max-w-7xl mx-auto px-4 py-8" }, [
                  __props.activeTab === "standard" ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                    __props.posts.data?.length ? (openBlock(), createBlock(_sfc_main$2, {
                      key: 0,
                      posts: __props.posts.data
