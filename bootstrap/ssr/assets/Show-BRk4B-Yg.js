...
import { A as AppLayout, _ as _sfc_main$e } from "./AppLayout-Box-YIyP.js";
import { _ as _sfc_main$d, b as buildResponsiveImage } from "./PostCard-BwkqJ6T-.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (!__props.post.format || __props.post.format === "standard") {
              _push2(`<div class="lg:grid lg:grid-cols-[minmax(0,750px)_240px] lg:items-start lg:gap-10"${_scopeId}><div data-reading-body class="min-w-0"${_scopeId}><div class="prose prose-lg mx-auto max-w-[750px] prose-headings:text-gray-900 prose-p:text-gray-700 prose-a:text-red-600 prose-a:hover:text-red-700"${_scopeId}><div${_scopeId}>${processedContent.value ?? ""}</div></div></div>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$c, { posts: __props.relatedPosts }, null, _parent2, _scopeId));
            _push2(`</div></article>`);
              ...
              createVNode("article", { class: "min-h-screen bg-white" }, [
                ...
                createVNode("div", { class: "max-w-6xl mx-auto px-4 -mt-32 relative z-10" }, [
                  createVNode("div", { class: "bg-white rounded-t-2xl md:rounded-2xl shadow-sm p-6 md:p-10" }, [
                    ...
                    __props.post.is_revisit || __props.post.revisits && __props.post.revisits.length > 0 ? (openBlock(), createBlock(_sfc_main$3, {
                      key: 0,
                      "original-post": __props.post.original_post,
                      revisits: __props.post.revisits || [],
                      "is-revisit": __props.post.is_revisit,
                    ...
                    !__props.post.format || __props.post.format === "standard" ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("div", {
                        ...
                        createVNode("div", { class: "prose prose-lg mx-auto max-w-[750px] prose-headings:text-gray-900 prose-p:text-gray-700 prose-a:text-red-600 prose-a:hover:text-red-700" }, [
                          createVNode("div", { innerHTML: processedContent.value }, null, 8, ["innerHTML"])
                        ])
                      ], 512),
                    ...
                    ])) : __props.post.format === "dialogue" ? (openBlock(), createBlock(_sfc_main$2, {
                      key: 3,
                      exchanges: __props.post.dialogue_exchanges || [],
                      "primary-author": __props.post.user,
                      "secondary-author": __props.post.secondary_author,
                      intro: __props.post.content
                    }, null, 8, ["exchanges", "primary-author", "secondary-author", "intro"])) : __props.post.format === "visual_essay" ? (openBlock(), createBlock(_sfc_main$1, {
                      key: 4,
                      blocks: __props.post.visual_essay_blocks || []
                ...
                createVNode("div", { class: "max-w-7xl mx-auto px-4 py-12" }, [
                  createVNode(_sfc_main$c, { posts: __props.relatedPosts }, null, 8, ["posts"])
                ])
              ]),
