...
import { A as AppLayout } from "./AppLayout-DLzUu67n.js";
              ...
              createVNode("div", { class: "min-h-screen bg-gray-50" }, [
                createVNode("div", { class: "bg-white border-b border-gray-200" }, [
                  createVNode("div", { class: "max-w-7xl mx-auto px-4 py-8" }, [
                    createVNode("h1", { class: "text-3xl font-bold text-gray-900" }, "Sinema Haritasi"),
                    createVNode("p", { class: "mt-2 text-gray-600" }, "Istanbul'daki bagimsiz sinemalar, gosterimdeki filmler ve kullanici yorumlari")
                  ])
                ]),
                createVNode("div", { class: "max-w-7xl mx-auto px-4 py-8" }, [
                  createVNode("div", {
